    ...
    <AdminLayout
      ...
      headerToolbar={(
        <div className="flex items-center gap-3">
          ...
          <Link
            href={{ pathname: "/calendar/week", query: { date: prevAnchorISO } }}
          ...
          <Link
            href={{ pathname: "/calendar/week", query: { date: todayISO } }}
            className="rounded-md border border-slate-200 px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50"
          >
            Hoy
          </Link>
          <Link
            href={{ pathname: "/calendar/week", query: { date: nextAnchorISO } }}
            className="flex items-center gap-1 rounded-md border border-slate-200 px-3 py-2 text-sm text-slate-600 hover:bg-slate-50"
          >
