...
--
-- Name: TYPE category; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TYPE public.category IS 'Categoria del curso';
...
--
-- Name: course_visibility; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: TYPE intensity; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TYPE public.intensity IS 'Intensidad de la clase';
...
--
-- Name: instructor_class_types; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: messages_2025_09_27; Type: TABLE; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2025_09_27; Type: TABLE ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: class_types class_types_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: instructor_class_types instructor_class_types_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.instructor_class_types
    ADD CONSTRAINT instructor_class_types_pkey PRIMARY KEY (instructor_id, class_type_id);
...
--
-- Name: messages_2025_09_27 messages_2025_09_27_pkey; Type: CONSTRAINT; Schema: realtime; Owner: -
--
...
--
-- Name: courses_class_type_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX courses_class_type_id_idx ON public.courses USING btree (class_type_id);


--
-- Name: idx_ict_class_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ict_class_type ON public.instructor_class_types USING btree (class_type_id);


--
-- Name: idx_ict_instructor; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ict_instructor ON public.instructor_class_types USING btree (instructor_id);
...
--
-- Name: messages_2025_09_25_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2025_09_26_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2025_09_27_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2025_09_25_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2025_09_26_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2025_09_27_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2025_09_27_pkey; Type: INDEX ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: client_profiles trg_client_profiles_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_client_profiles_updated_at BEFORE UPDATE ON public.client_profiles FOR EACH ROW EXECUTE FUNCTION public.set_updated_at_timestamp();
...
CREATE TRIGGER trg_courses_updated_at BEFORE UPDATE ON public.courses FOR EACH ROW EXECUTE FUNCTION public.set_updated_at_timestamp();


--
-- Name: membership_types trg_membership_types_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_membership_types_updated_at BEFORE UPDATE ON public.membership_types FOR EACH ROW EXECUTE FUNCTION public.set_updated_at_timestamp();
...
--
-- Name: courses courses_class_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.courses
    ADD CONSTRAINT courses_class_type_id_fkey FOREIGN KEY (class_type_id) REFERENCES public.class_types(id) ON DELETE SET NULL;


--
-- Name: courses courses_lead_instructor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: instructor_class_types instructor_class_types_class_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.instructor_class_types
    ADD CONSTRAINT instructor_class_types_class_type_id_fkey FOREIGN KEY (class_type_id) REFERENCES public.class_types(id) ON DELETE CASCADE;


--
-- Name: instructor_class_types instructor_class_types_instructor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.instructor_class_types
    ADD CONSTRAINT instructor_class_types_instructor_id_fkey FOREIGN KEY (instructor_id) REFERENCES public.instructors(id) ON DELETE CASCADE;
...
--
-- Name: client_profiles client_profiles_admin_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY client_profiles_admin_all ON public.client_profiles USING (((auth.jwt() ? 'is_admin'::text) AND ((auth.jwt() ->> 'is_admin'::text))::boolean)) WITH CHECK (((auth.jwt() ? 'is_admin'::text) AND ((auth.jwt() ->> 'is_admin'::text))::boolean));
...
CREATE POLICY courses_admin_all ON public.courses USING (((auth.jwt() ? 'is_admin'::text) AND ((auth.jwt() ->> 'is_admin'::text))::boolean)) WITH CHECK (((auth.jwt() ? 'is_admin'::text) AND ((auth.jwt() ->> 'is_admin'::text))::boolean));
...
\nALTER TABLE public.courses ADD COLUMN IF NOT EXISTS default_room_id uuid;\nALTER TABLE public.courses\n  ADD CONSTRAINT courses_default_room_id_fkey\n  FOREIGN KEY (default_room_id) REFERENCES public.rooms(id);\n
\nALTER TABLE public.rooms ADD COLUMN IF NOT EXISTS location text;\n\nCREATE TABLE public.room_blocks (\n    id uuid DEFAULT gen_random_uuid() NOT NULL,\n    room_id uuid NOT NULL,\n    starts_at timestamp with time zone NOT NULL,\n    ends_at timestamp with time zone NOT NULL,\n    reason text,\n    note text,\n    created_at timestamp with time zone DEFAULT now() NOT NULL\n);\nALTER TABLE public.room_blocks ADD CONSTRAINT room_blocks_pkey PRIMARY KEY (id);\nALTER TABLE public.room_blocks ADD CONSTRAINT room_blocks_room_id_fkey FOREIGN KEY (room_id) REFERENCES public.rooms(id) ON DELETE CASCADE;\n\nCREATE TABLE public.room_recurring_blocks (\n    id uuid DEFAULT gen_random_uuid() NOT NULL,\n    room_id uuid NOT NULL,\n    weekday smallint NOT NULL,\n    start_time time NOT NULL,\n    end_time time NOT NULL,\n    reason text,\n    note text,\n    created_at timestamp with time zone DEFAULT now() NOT NULL\n);\nALTER TABLE public.room_recurring_blocks ADD CONSTRAINT room_recurring_blocks_pkey PRIMARY KEY (id);\nALTER TABLE public.room_recurring_blocks ADD CONSTRAINT room_recurring_blocks_room_id_fkey FOREIGN KEY (room_id) REFERENCES public.rooms(id) ON DELETE CASCADE;\n\nCREATE TABLE public.room_apparatus (\n    id uuid DEFAULT gen_random_uuid() NOT NULL,\n    room_id uuid NOT NULL,\n    apparatus_id uuid NOT NULL,\n    quantity integer NOT NULL,\n    created_at timestamp with time zone DEFAULT now() NOT NULL\n);\nALTER TABLE public.room_apparatus ADD CONSTRAINT room_apparatus_pkey PRIMARY KEY (id);\nALTER TABLE public.room_apparatus ADD CONSTRAINT room_apparatus_room_id_fkey FOREIGN KEY (room_id) REFERENCES public.rooms(id) ON DELETE CASCADE;\nALTER TABLE public.room_apparatus ADD CONSTRAINT room_apparatus_apparatus_id_fkey FOREIGN KEY (apparatus_id) REFERENCES public.apparatus(id) ON DELETE CASCADE;\nALTER TABLE public.room_apparatus ADD CONSTRAINT room_apparatus_unique UNIQUE (room_id, apparatus_id);\n
