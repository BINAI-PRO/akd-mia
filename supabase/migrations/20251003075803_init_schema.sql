...
--
-- Name: membership_types additional columns; Type: TABLE; Schema: public; Owner: -
--

ALTER TABLE public.membership_types
    ADD COLUMN trial_days integer,
    ADD COLUMN access_classes boolean DEFAULT true NOT NULL,
    ADD COLUMN access_courses boolean DEFAULT false NOT NULL,
    ADD COLUMN access_events boolean DEFAULT false NOT NULL,
    ADD COLUMN updated_at timestamp with time zone DEFAULT now() NOT NULL;


--
-- Name: membership_usages additional columns; Type: TABLE; Schema: public; Owner: -
--

ALTER TABLE public.membership_usages
    ADD COLUMN credit_delta integer DEFAULT 1 NOT NULL,
    ADD COLUMN notes text;


--
-- Name: sessions course link; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: courses courses_class_type_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: event_sessions event_sessions_instructor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_sessions
    ADD CONSTRAINT event_sessions_instructor_id_fkey FOREIGN KEY (instructor_id) REFERENCES public.instructors(id) ON DELETE SET NULL;


--
-- Name: event_sessions event_sessions_room_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_sessions
    ADD CONSTRAINT event_sessions_room_id_fkey FOREIGN KEY (room_id) REFERENCES public.rooms(id) ON DELETE SET NULL;
...
CREATE POLICY events_admin_all ON public.events USING (((auth.jwt() ? 'is_admin'::text) AND ((auth.jwt() ->> 'is_admin'::text))::boolean)) WITH CHECK (((auth.jwt() ? 'is_admin'::text) AND ((auth.jwt() ->> 'is_admin'::text))::boolean));


--
-- Name: event_sessions event_sessions_public_read; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: event_sessions event_sessions_admin_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY event_sessions_admin_all ON public.event_sessions USING (((auth.jwt() ? 'is_admin'::text) AND ((auth.jwt() ->> 'is_admin'::text))::boolean)) WITH CHECK (((auth.jwt() ? 'is_admin'::text) AND ((auth.jwt() ->> 'is_admin'::text))::boolean));
...
CREATE TRIGGER trg_events_updated_at BEFORE UPDATE ON public.events FOR EACH ROW EXECUTE FUNCTION public.set_updated_at_timestamp();
